...
// Mapping of routes to Chinese titles
...
val drawerMenuItems = listOf(
    ...
    DrawerMenuItem("holidays", Icons.Default.MoreVert, "節日清單"),
    DrawerMenuItem("NormalList", Icons.Filled.FavoriteBorder, "常備清單"),
    DrawerMenuItem("Expired_food", Icons.Default.Delete, "過期食材"),
    DrawerMenuItem("logout", Icons.Default.Person, "登出")
        ...
        content = {
            Scaffold(
                ...
                NavHost(navController = navController, startDestination = "home_page", Modifier.padding(paddingValues)) {
                    ...
                    composable("Addholiday") { HolidayAdd(navController) }
